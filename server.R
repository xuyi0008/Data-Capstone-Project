  ...
  isolate({
    withProgress(message = 'Loading required n-grams...',
                 detail = 'This may take a several seconds...', value = 0, {
                   unigramModelNews <- readRDS(file = "nunigramModelReduced.rds")
                 
                   bigramModelNews <- readRDS(file = "nbigramModelReduced.rds")
                
                   trigramModelNews <- readRDS(file = "ntrigramModelReduced.rds")
                  
                   fourgramModelNews <- readRDS(file = "nfourgramModelReduced.rds")
                  
                   unigramModelTwitter <- readRDS(file = "unigramModelReduced.rds")
                  
                   bigramModelTwitter <- readRDS(file = "bigramModelReduced.rds")
                  
                   trigramModelTwitter <- readRDS(file = "trigramModelReduced.rds")
                 
                   fourgramModelTwitter <- readRDS(file = "fourgramModelReduced.rds")
